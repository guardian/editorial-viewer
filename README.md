...
The javascript bundle (public/build.js - file is gitignored) need to be built for the frontend to work properly when running locally:
 - install the version of npm specified in [./nvmrc](./nvmrc) - e.g. nvm : `nvm use`
 - install the dependencies : `npm ci`
 - run the bundle script: `npm run build`
...
- [`vite`](https://vite.dev/) is used to compile and bundle the javascript source code to run in the browser
