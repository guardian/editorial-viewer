...
(function(process) {
  ...
  function node_beautifier_legacy_tests(name, test_runner) {
    ...
    test_runner(results, Urlencoded, beautify.js_beautify, beautify.html_beautify, beautify.css_beautify);
  ...
  if (require.main === module) {
    process.exit(node_beautifier_tests('js-beautifier', run_javascript_tests).get_exitcode() + node_beautifier_legacy_tests('js-beautifier', run_javascript_tests).get_exitcode() + node_beautifier_tests('cs-beautifier', run_css_tests).get_exitcode() + node_beautifier_legacy_tests('css-beautifier', run_css_tests).get_exitcode() + node_beautifier_tests('html-beautifier', run_html_tests).get_exitcode() + node_beautifier_legacy_tests('html-beautifier', run_html_tests).get_exitcode());
  }
})(require("process"));
